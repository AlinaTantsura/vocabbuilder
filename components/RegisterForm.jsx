...
const RegisterForm = () => {
  ...
  return (
    <form className="flex flex-col gap-[14px]">
        <input {...register("name")} placeholder="Name" className="border border-[#121417]/[.1] rounded-[15px] px-[18px] py-4 font-normal text-[16px] leading-[150%] placeholder-black-main outline-none hover:border-green-main focus:border-green-main" />
